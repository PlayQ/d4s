...
object Models {
  ...
  object Table1Key {
    implicit val codec: D4SCodec[Table1Key] = D4SCodec[Table1Key]
  }
  ...
  object Table1Item {
    implicit val codec: D4SCodec[Table1Item] = D4SCodec[Table1Item]
  }
  object Table1ItemWithCounter {
    implicit val codec: D4SCodec[Table1ItemWithCounter] = D4SCodec[Table1ItemWithCounter]
  }
  ...
  object InterpreterTestKey {
    implicit val codec: D4SCodec[InterpreterTestKey] = D4SCodec[InterpreterTestKey]
  }
  ...
  object InterpreterTestPayload {
    ...
    implicit val codec: D4SCodec[InterpreterTestPayload] = D4SCodec[InterpreterTestPayload]
  }
  ...
  object RandomPayload {
    ...
    implicit val codec: D4SCodec[RandomPayload] = D4SCodec[RandomPayload]
  }

  case class TestD(i: Int, d: Double)
  object TestD {
    implicit val codec: D4SCodec[TestD] = D4SCodec[TestD]
  }

  final case class TestCase(r: TestD)
  object TestCase {
    implicit val codec: D4SCodec[TestCase] = D4SCodec[TestCase]
    implicit val configReader: DIConfigReader[TestCase] = DIConfigReader.derive
  }
}
